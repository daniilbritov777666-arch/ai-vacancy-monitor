...
Агент не отправляет сообщения заказчику напрямую на бирже или в стороннем мессенджере, пока для конкретного контакта не подключен разрешенный канал отправки. Сейчас он готовит `outbox/customer_message.md` и уведомляет в Telegram.
