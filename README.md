...
Сейчас автоотправка первого отклика, чтение входящей переписки, автоотправка безопасных последующих ответов и подготовка рабочих пакетов поддержаны для Freelancehunt через официальный API. Отправка результата и принятие оплаты остаются точками подтверждения.
