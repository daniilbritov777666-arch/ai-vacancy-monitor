...
export MARKETPLACE_BROWSER_ENABLED="${MARKETPLACE_BROWSER_ENABLED:-true}"
export MARKETPLACE_BROWSER_LIVE_SUBMIT="${MARKETPLACE_BROWSER_LIVE_SUBMIT:-false}"
export MARKETPLACE_BROWSER_PROFILE_DIR="${MARKETPLACE_BROWSER_PROFILE_DIR:-$HOME/.codex/marketplace-browser-profile}"
export MARKETPLACE_BROWSER_HEADLESS="${MARKETPLACE_BROWSER_HEADLESS:-false}"
export MARKETPLACE_BROWSER_CONVERSATION_ENABLED="${MARKETPLACE_BROWSER_CONVERSATION_ENABLED:-true}"
export MARKETPLACE_BROWSER_REPLY_LIVE="${MARKETPLACE_BROWSER_REPLY_LIVE:-false}"
export MARKETPLACE_BROWSER_ORDERS_PER_CYCLE="${MARKETPLACE_BROWSER_ORDERS_PER_CYCLE:-3}"
