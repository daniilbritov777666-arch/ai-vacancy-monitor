...
- [x] **Step 3: Implement queue records and atomic operations**
...
- [x] **Step 4: Add retry, dead-letter and lease recovery tests**
...
- [x] **Step 3: Write failing retry-classification tests**
...
- [x] **Step 4: Implement worker helpers and atomic reports**
...
- [x] **Step 1: Preserve and verify current outreach diagnostics**
...
- [x] **Step 2: Write failing producer isolation test**
...
- [x] **Step 3: Implement enqueue and reconciliation**
...
- [x] **Step 4: Make autopilot errors observable to worker**
...
- [x] **Step 6: Implement bounded worker loop**
...
- [x] **Step 1: Document queue settings and runtime files**
...
- [x] **Step 3: Commit current outreach diagnostics and queue implementation**
...
- [x] **Step 4: Reload LaunchAgent and verify migration**
...
- [x] **Step 5: Verify crash recovery**
