...
class Config:
    ...
    freelancehunt_browser_enabled: bool = False
    freelancehunt_browser_live_submit: bool = False
    freelancehunt_browser_profile_dir: Path = Path.home() / ".codex" / "freelancehunt-browser-profile"
    freelancehunt_browser_executable_path: str | None = None
    freelancehunt_browser_timeout_seconds: int = 120
    ...
    def from_env(cls) -> "Config":
        ...
        freelancehunt_browser_enabled = _env_bool("FREELANCEHUNT_BROWSER_ENABLED")
        freelancehunt_browser_live_submit = _env_bool("FREELANCEHUNT_BROWSER_LIVE_SUBMIT")
        freelancehunt_browser_profile_dir = Path(
            os.environ.get(
                "FREELANCEHUNT_BROWSER_PROFILE_DIR",
                str(Path.home() / ".codex" / "freelancehunt-browser-profile"),
            )
        )
        freelancehunt_browser_executable_path = (
            os.environ.get("FREELANCEHUNT_BROWSER_EXECUTABLE_PATH", "").strip() or None
        )
        freelancehunt_browser_timeout_seconds = min(
            300,
            max(30, int(os.environ.get("FREELANCEHUNT_BROWSER_TIMEOUT_SECONDS", "120"))),
        )
        ...
        return cls(
            ...
            freelancehunt_browser_enabled=freelancehunt_browser_enabled,
            freelancehunt_browser_live_submit=freelancehunt_browser_live_submit,
            freelancehunt_browser_profile_dir=freelancehunt_browser_profile_dir,
            freelancehunt_browser_executable_path=freelancehunt_browser_executable_path,
            freelancehunt_browser_timeout_seconds=freelancehunt_browser_timeout_seconds,
